...
import numpy as np
import scipy as sp
from functions import PySPMs as PySPM
...
#-----------------------------------------------------------------------------#
def neuronal_signals(ons, dur, stim, TR, mtr, mu_log, sig_log, lin=False, fine_t = False):
    """
    ...
    dt  = TR/mtr
    if fine_t:
        dt = 0.01 # temporal resolution for very short audiotry stimuli, like 0.01 sec beep tone
...
#-----------------------------------------------------------------------------#
def hemodynamic_signals(Z, t, n, mtr, mto=1, p=None, order=1, fine_t = False):
    """
